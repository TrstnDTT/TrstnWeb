    ...
    items: [
      {
        ...
        alt: 'Macro mandala — précision géométrique sur grain fin',
        needle: '3RL',
        time: '5h 30',
        ink: 'Carbon Black',
        layout: 'tall',
      ...
      {
        src: `${TP}/thomas-pineiro-tattoo.webp`,
        alt: 'Réalisme — pores et volumes sous shader',
        needle: '7M',
        time: '4h',
        ink: 'Pitch Black',
        layout: 'wide',
      },
      {
        ...
        alt: 'Néo-trad — aplats et arêtes nettes',
        needle: '5RL',
        time: '3h 15',
        ink: 'True Black',
        layout: 'square',
      ...
      {
        src: `${TP}/mandala-robin.jpg`,
        alt: 'Répétition motif — homogénéité du trait',
        needle: '3RL',
        time: '6h',
        ink: 'Carbon Black',
        layout: 'banner',
      },
      {
        ...
        alt: 'Contraste lumière / ombre sur relief cutané',
        needle: '9M',
        time: '2h',
        ink: 'Sumi',
        layout: 'tall',
