...
export const ATELIER_SUCRE_DEFAULT = {
  heroImage: `${U}/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=2000&q=88`,
    ...
    items: [
      {
        ...
        image: `${U}/photo-1519915028121-7d3463d20b13?auto=format&fit=crop&w=900&q=85`,
      },
      {
        name: 'Éclair au yuzu',
        note: 'Pâte à choux légère · crémeux agrume',
        image: `${U}/photo-1558961363-fa8fdf82db35?auto=format&fit=crop&w=900&q=85`,
      },
      {
        name: 'Macarons (assortiment)',
        note: 'Ganache infusée · coques satinées',
        image: `${U}/photo-1563729784474-d77dbb933a9e?auto=format&fit=crop&w=900&q=85`,
      },
      {
        name: 'Saint-Honoré revisité',
        note: 'Choux caramélisés · vanille Bourbon',
        image: `${U}/photo-1621303837174-89787a7d4729?auto=format&fit=crop&w=900&q=85`,
      },
    ],
  },
  ingredientRare: {
    ...
    image: `${U}/photo-1587049352846-4a222e31d821?auto=format&fit=crop&w=1400&q=85`,
  },
  barTartes: {
    ...
    items: [
      {
        ...
        image: `${U}/photo-1519915028121-7d3463d20b13?auto=format&fit=crop&w=600&q=85`,
      },
      {
        name: 'Pistache & griotte',
        image: `${U}/photo-1565958011703-44f9829ba187?auto=format&fit=crop&w=600&q=85`,
      },
      {
        name: 'Chocolat grand cru',
        image: `${U}/photo-1578985545062-69928b1d9587?auto=format&fit=crop&w=600&q=85`,
      },
      {
        name: 'Fraise Gariguette',
        image: `${U}/photo-1464349095431-e9a21285b5f3?auto=format&fit=crop&w=600&q=85`,
      },
    ],
  },
}
