...
export function ChaiModerneBarExperience({ site, onBack }) {
  ...
  const wines = site.chaiWines ?? [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1594372365409-9b78347a16c1?w=800&q=80',
    },
  ]
  ...
  return (
    ...
    >
      <BarExperienceChrome progress={progress} anchors={anchors} accentColor={OAK} dark={false} />

      <BackButton onClick={onBack} site={site} />

      <header
        id="chai-hero"
        className="relative scroll-mt-2 px-6 pb-16 pt-[calc(6rem+env(safe-area-inset-top))] md:px-16 md:pb-24 md:pt-28"
      >
        ...
        <div className="mx-auto mt-16 max-w-5xl overflow-hidden rounded-[8px] border-[0.5px] border-black/[0.1] shadow-[0_24px_60px_-20px_rgba(0,0,0,0.12)]">
          <img src={assets.hero} alt="" className="aspect-[21/9] w-full object-cover md:aspect-[2.4/1]" style={{ filter: softPhoto }} />
        </div>
      ...
      {/* Bento vins */}
      <section id="chai-bento" className="scroll-mt-20 px-6 py-16 md:px-16 md:py-24">
        <h2
      ...
      {/* Timeline carte */}
      <section id="chai-time" ref={timelineRef} className="relative scroll-mt-20 border-y-[0.5px] border-black/[0.08] bg-white/60 px-6 py-20 md:px-16 md:py-28">
      ...
      {/* Terroir */}
      <section id="chai-terroir" className="scroll-mt-20 px-6 py-24 md:px-16 md:py-32">
        <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mx-auto mt-16 grid max-w-6xl gap-8 md:grid-cols-2 md:gap-10">
          ...
          >
            <img src={assets.terroir1} alt="" className="aspect-[4/3] w-full object-cover" style={{ filter: softPhoto }} />
          ...
          <motion.div
            ...
            className="overflow-hidden rounded-[8px] border-[0.5px] border-black/[0.08]"
          >
            <img src={assets.terroir2} alt="" className="aspect-[4/3] w-full object-cover" style={{ filter: softPhoto }} />
        ...
        <div className="mx-auto mt-14 max-w-3xl overflow-hidden rounded-[8px] border-[0.5px] border-black/[0.08]">
          <img src={assets.tapas} alt="" className="aspect-[21/9] w-full object-cover" style={{ filter: softPhoto }} />
        </div>
      ...
      <footer id="chai-footer" className="scroll-mt-20 border-t-[0.5px] border-black/[0.08] px-6 py-16 md:px-16">
